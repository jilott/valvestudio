...
t = Transformer.Transformer([primary,secondary6,secondary6b,secondary12,secondary12b,secondary5,secondary5b],160,have=0)
...
t.fluxDensity = t.fluxFind(bmax=103000,inc=100,fillmax=90)
#t.fluxDensity = 90000
t.compute()
t.report()
